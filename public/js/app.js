...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // importamos Swall
...
var agregarContacto = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            form = crearFormulario(); // limpiamos los errores del formulario

            limpiarErrores(form); // validamos que el formulario no tenga registros vacios

            validar = validarForm(form); // si la validacion es false notificamos el error
...
var notificarErrores = function notificarErrores(errores) {
...
var limpiarErrores = function limpiarErrores(form) {
...
var crearFormulario = function crearFormulario() {
  var form = {
...
var notificacion = function notificacion(title, text, icon) {
